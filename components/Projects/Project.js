...
export default function Project({ img, title, description, tools, link }) {
  return (
    <div className=" flex w-4/5 flex-wrap gap-10 rounded-3xl border border-solid border-slate-50 bg-slate-600 bg-opacity-20 p-10 text-dynamic-lg drop-shadow-lg md:flex-nowrap 	">
