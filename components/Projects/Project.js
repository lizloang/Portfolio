...
export default function Project({ img, title, description, tools, link }) {
  return (
    <div className=" flex w-4/5 gap-10 rounded-3xl border border-solid border-slate-50 bg-slate-600 bg-opacity-20 p-10 drop-shadow-lg 	">
      ...
      <div className="flex flex-col gap-2">
        ...
        <section className="fflex-wrap flex gap-2">
          {tools.map((tool, id) => {
